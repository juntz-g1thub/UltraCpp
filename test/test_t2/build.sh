...
BUILD_DIR="$PROJECT_ROOT/build/linux/test_t2"

echo "=== UltraCPP Test: test_t2 (variable declaration) ==="
echo ""
...
gcc "$BUILD_DIR/main.s" -o "$BUILD_DIR/test_t2"

echo ""
echo "Done: $BUILD_DIR/test_t2"
