# UltraCPP 0.3.5 Language Specification

> **Version**: 0.3.5
>
> **Previous version**: 0.3.4 — [`UltraCPP-v0.3.4-spec-en.md`](./UltraCPP-v0.3.4-spec-en.md)
>
> **Status**: draft
>
> **Date**: 2026-08-21
>
> Same-version Chinese translation: [简体中文](./UltraCPP-v0.3.5-spec-zh-CN.md)
...
**Note 2**: `lib/io.uc` is a pre-0.3.3 test fixture file (containing legacy `sys$`-prefixed `print_str` and `getValue`), functionally overlapping with `lib/print.uc::uc_print_str`. Deprecated as of 0.3.5, **scheduled for deletion in 0.3.6**. `lib/io.uc` is NOT part of the §11.0.2 6-file list (print/string/memory/math/alloc/sys).
