...
> 当前快速摘要（最新一次 baseline，2026-08-12 HEAD `985eade`）：M0 **26/48 PASS / 22 FAIL**；
> P0-1 → P0-2 → P0-3 → P0-4 全部完成 + **P1-2 ✅ done** (m0_10 commit `09b4df5`) + **P1-3 ✅ done** (m0_13/14/15 commits `afae9c9` + `c8492ef`) + **P1-4 partial done** (m0_19 / m0_29 / m0_31，commits `a513226` + `985eade`；**m0_41 / m0_42 deferred to P3-5**)；剩 **P1-1 CJK** (m0_50 高风险)，长期推 **P3-5 pointer runtime**。
...
- [ ] **Borrow-check implementation in C host**：**当前活跃方向**，按 `.dev/plans/0.4.0-test-milestones.md` M0-M5 推进
  ...
  - [/] **M0 P1 in-progress** (HEAD `985eade`，2026-08-12，baseline **26/48 PASS / 22 FAIL**):
    ...
    - **remaining**: P1-1 (m0_50 CJK identifiers，高风险)；长期推 P3-5 pointer runtime (m0_29/m0_30/m0_34/m0_36/m0_41/m0_42)
