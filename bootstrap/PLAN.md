...
> (M0-M5 per `.dev/plans/0.3.0-borrow-check-milestones.md`). The bootstrap Level 0
...
>
> For the **current** active direction: see `.dev/plans/0.3.0-borrow-check-milestones.md`
